...
<head>
    ...
    .btn-dark {
        ...
        .alert-pay:hover {
            background-color: white; /* Changing background color on hover */
            color: green; /* Changing text color on hover */
            border: 2px solid #73a9c2; /* Red border */
        }
...
<header>
        <nav data-theme="@yield('navTheme')" class="home-nav @yield('navTheme')">
            ...
            <ul class="nav-links">
                ...
                <x-slot name="trigger">
                                <a href="/" onclick="return false;">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-utensils" style="font-size: 0.9em; vertical-align: middle;"></i>&nbsp;<span style="font-size: 1em;">Catering</span>&nbsp;&nbsp;
                                    </div>
                                </a>
                            </x-slot>
                            ...
                            <x-slot name="content" align="center" >
                                ...
                                @if (Auth::check() && auth()->user()->role == 'customer')
                                    ...
                                    <x-dropdown-link class="dropdown-item flex-md-row flex-column justify-content-md-between" 
                                                    style="background-color: rgba(255, 192, 77, 0.5);" 
                                                    :href="route('reservations.step.one')">
                                        Reserve <i class="fas fa-calendar-plus" style="font-size: 0.7em;"></i>
                                        {{ __('') }}
                                    </x-dropdown-link>
                                ...
                                @endif
                                    ...
                                    <x-dropdown-link class="dropdown-item flex-md-row flex-column justify-content-md-between " 
                                        ...
                                        <i class="fas fa-concierge-bell" style="font-size: 0.7em;"></i> Services
                                        {{ __('') }}
                                    </x-dropdown-link>
                                    ...
                                    <x-dropdown-link class="dropdown-item flex-md-row flex-column justify-content-md-between" 
                                                    ...
                                                    :href="route('gallery')">
                                       Gallery <i class="fas fa-images" style="font-size: 0.7em;"></i>
                                        {{ __('') }}
                                    </x-dropdown-link>
                                ...
                                @if (Auth::check() && auth()->user()->role == 'customer')
                                    ...
                                    <x-dropdown-link class="dropdown-item  flex-md-row flex-column justify-content-md-between" 
                                                    ...
                                                    &nbsp;&nbsp;Hist<i class="fas fa-history" style="font-size: 0.9em;"></i>ry
                                        {{ __('') }}
                                    </x-dropdown-link>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-hamburger" style="font-size: 0.9em; vertical-align: middle;"></i> 
                    <span style="font-size: 1em; margin-left: 2px;">Menu&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                </a>
                </li>
                ...
                @if (auth()->check())
                    ...
                    <li>
                    <a href="{{ route('cart') }}" class="flex items-center position-relative">
                            <i class="fas fa-shopping-cart" style="font-size: 0.9em; vertical-align: middle;"></i> 
                            <span style="font-size: 1em; margin-left: 2px; position: relative;">
                                Cart&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                @if($cartCount > 0)
                                    <span class="badge bg-danger position-absolute translate-middle p-1" 
                                        style="top: -5px; left: 45px; font-size: 0.75em; border-radius: 50%;">
                                        {{ $cartCount }}
                                    </span>
                                @endif
                            </span>
                    ...
                    <li>
                        <a href="{{ route('order') }}" class="flex items-center">
                            <i class="fas fa-clipboard-list" style="font-size: 0.9em; vertical-align: middle;"></i> 
                            <span style="font-size: 1em; margin-left: 2px;">Order&nbsp;&nbsp;</span>
                        </a>
                    </li>
                        </div>
                    ...
                    <li>
                        ...
                        @if (auth()->user()->role == 'admin')
                            ...
                            <i class="fa fa-ticket" style="font-size: 0.9em; vertical-align: middle;"></i> 
                            <span style="font-size: 1em; margin-left: 2px;">Discount&nbsp;&nbsp;</span>                        
                            </a>
                            </li>
                        @endif
                    @endif
            ...
            <div style="position: fixed; top: 10px; right: 30px;">
                <x-notify::notify />
                    ...
                    <div x-show="openDropdown" x-cloak class="origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5"> <!-- Changed w-48 to w-40 -->
                        <div class="py-1">
                            <!-- Dashboard Option -->
                            <x-dropdown-link :href="route('home')" class="flex items-center text-gray-700 hover:bg-gray-100 rounded-md p-1 text-xs no-text-shadow">
                ...
                <style>
                .custom-left-margin {
                    text-shadow: none !important; /* Removes any existing text shadow */
                    color: inherit; /* Ensures the text color matches the navbar */
                }

                .notifications-dropdown {
                    text-shadow: none !important; /* Ensures dropdown text has no shadow */
                }

                .notification i, .notification .badge {
                    text-shadow: none !important; /* Specifically remove icon or badge text shadow */
                }
                </style>
            ...
            <div class="burger position-relative" id="burgerMenu">
                @if($cartCount > 0)
                    <span class="badge bg-danger position-absolute top-0 start-100 translate-middle p-1" 
                        style="font-size: 0.75em; border-radius: 50%; transform: translate(-50%, -50%);" id="cartBadge">
                        {{ $cartCount }}
                    </span>
                @endif
                <div class="line1"></div>
            ...
            <!-- Burger menu code (for example, a dropdown or side menu) -->
            <div class="burger-menu">
                <!-- Your burger menu content here -->
            </div>

            <!-- Add this JavaScript to handle showing/hiding the badge -->
            <script>
