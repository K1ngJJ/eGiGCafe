                ...
                <tbody>
                                    @foreach ($services as $service)
                                        <tr>
                                            ...
                                            <td
                                            class="py-3 px-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                                <div class="my-md-1 px-2 py-1"><img src="{{ asset('eventImages/' . $service->image) }}" class="w-16 h-16 rounded"></div>
                                            </td>
                                            <td
                                            class="py-3 px-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-4 bg-light custom-modal-body">
                                        ...
                                        <div class="reservation-info">
                                            ...
                                            <div class="info-item">
                                                <span class="info-label">Image:</span> <span class="info-value"><img src="{{ asset('eventImages/' . $service->image) }}" class="w-16 h-16 rounded"></span>
                                            </div>
                                            <div class="info-item">
