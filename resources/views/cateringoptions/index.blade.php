...
<section class="kitchen-previous-orders min-vh-100 d-flex align-items-center mt-lg-0 mt-3">
    ...
    <div class="row my-5 justify-content-between">
        ...
        <div class="d-flex">
            ...
            <a class="my-md-1 px-3 py-2 bg-red-500 btn-sm primary-btn flex-md-row flex-column justify-content-md-between" href="{{ route('inventory.index') }}">
                <i class="fas fa-box" style="font-size: 17px;"></i>
 ...
 <div class="table-responsive">
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">
                            <div class="px-4 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase"><b>Image</b></div></th>
                            <th scope="col">
                            <div class="px-4 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase"><b>Description</b></div></th>
                            <th scope="col">
                ...
                <tbody>
                                    ...
                                    @foreach ($cateringoptions as $cateringoption)
                                        <tr>
                                            <td
                                            class="py-3 px-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                                <div class="my-md-1 px-2 py-1">{{ $cateringoption->name }}</div>
                                            </td>
                                            <td
                                            class="py-3 px-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                                <div class="my-md-1 px-2 py-1"><img src="{{ asset('cateringoptionsImages/' . $cateringoption->image) }}" class="w-16 h-16 rounded"></div>
                                            </td>
                                            <td
                                            class="py-3 px-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-4 bg-light custom-modal-body">
                                        ...
                                        <div class="reservation-info">
                                            ...
                                            <div class="info-item">
                                                <span class="info-label">Image:</span> <span class="info-value"><img src="{{ asset('cateringoptionsImages/' . $cateringoption->image) }}" class="w-16 h-16 rounded"></span>
                                            </div>
                                            <div class="info-item">
