                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">
                            <div class="px-4 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase"><b>Guest Limit</b></div></th>
                            <th scope="col">
                ...
                <tbody>
                                    @foreach ($package as $packages)
                                        <tr>
                                            ...
                                            <td
                                            class="py-3 px-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                                <div class="my-md-1 px-2 py-1"><img src="{{ asset('packagesImages/' . $packages->image) }}" class="w-16 h-16 rounded"></div>
                                            </td>
                                            <td
                                               class="py-3 px-3 text-sm font-medium text-gray-900 whitespace-nowrap">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-4 bg-light custom-modal-body">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <select id="packageStatus{{ $packages->id }}" class="form-control">
                                                @foreach (App\Enums\PackageStatus::cases() as $status)
                                                    <option value="{{ $status->value }}" {{ $packages->status->value === $status->value ? 'selected' : '' }}>
                                                        {{ $status->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="reservation-info">
                                            ...
                                            <div class="info-item">
                                                <span class="info-label">Image:</span> <span class="info-value"><img src="{{ asset('packagesImages/' . $packages->image) }}" class="w-16 h-16 rounded"></span>
                                            </div>
                                            <div class="info-item">
