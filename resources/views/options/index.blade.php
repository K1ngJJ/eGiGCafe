        ...
        <div class="col-12 pt-3 h-100 shadow rounded bg-white ">
            ...
            <div class="d-flex">
                ...
                <div class="mt-1 p-2 text-sm text-gray-700 bg-yellow-100 border-l-4 border-yellow-500 flex items-center">
                    ...
                    <!-- Text message -->
                    <span>For more information about our catering events, please check our <a href="{{ route('cservices.index') }}" class="text-blue-500 underline" style="color: #FF8C00;">events</a>.</span>
                </div>
            </div>
...
<div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
    <img class="w-full h-48" src="{{ asset('cateringoptionsImages/' . $cateringoption->image) }}" alt="Image" />
    <div class="px-6 py-4">
    ...
    <div class="modal-dialog relative max-w-lg mx-auto" role="document">
        <div class="modal-content bg-white rounded-lg shadow-lg transition-transform transform scale-95 duration-300 ease-in-out">
            ...
            <div class="modal-body p-4">
                <img class="w-full h-48 mb-4" src="{{ asset('cateringoptionsImages/' . $cateringoption->image) }}" alt="Image" />
