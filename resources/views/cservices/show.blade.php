    ...
    border-radius: 8px;
                ...
                <div class="row justify-content-center">
                    <div class="col-12 pt-3 h-100 shadow rounded bg-white ">
                        ...
                        <h2 class="d-flex justify-content-center menu-title ">
                ...
                @if (Auth::check() && auth()->user()->role == 'customer')
                    <div class="col-md-1 d-flex align-items-center">
                        <div class="dropstart">
                            ...
                            <div class="dropdown-menu p-3 text-xs" style="width: 80%; max-width: 300px; min-width: 300px;">
                                <form method="POST" action="{{ route('cservice.store') }}" enctype="multipart/form-data"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group mb-3">
                                            <input name="name" id="name" type="text"
                                                class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-xs leading-normal transition duration-150 ease-in-out xs:text-xs sm:leading-5"
                                    ...
                                    <div class="input-group mb-3" hidden>
                                        <input name="description" id="description" type="text"
                                            class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-xs leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5"
            ...
            <div class="d-flex flex-wrap mt-4 mb-5">
                ...
                <div class="card col-md-3 col-6 d-flex align-items-center">
                    <div class="card-body col-12 pt-5 h-100 max-w-xs mx-4 mb-6 rounded-lg shadow-lg shadow rounded bg-white">
                        <div style="height: 200px; overflow: hidden;">
                             <img class="card-img-top menuImage" src="{{ asset('packagesImages/' . ($package->image ?: 'White Logo.png')) }}"
                             alt="Package Image" 
                              style="{{ $package->image === 'White Logo.png' ? 'object-fit: none; width: 100%; height: 100%;' : 'object-fit: cover; width: 100%; height: 100%;' }}" />
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">
                            <span class="short-description">
                                {{ Str::limit($package->description, 78) }} <!-- Adjust character limit as needed -->
                            </span>
                            <span class="full-description" style="display: none;">
                                {{ $package->description }}
                            </span>
                            <a href="#" class="toggle-description" onclick="toggleDescription(event, this)">See more...</a>
                        </h6>
                ...
                @if ($package->user_id !== null)
                    <div class="d-flex justify-content-end mt-3">
                        ...
                        <button type="button" class="my-md-1 px-2 py-1 bg-red-500 btn-sm primary-btn d-flex flex-md-row flex-column justify-content-md-between" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $package->id }}">
