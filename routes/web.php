...
Route::middleware(['auth'])->group(function () {
    ...
    Route::patch('/packages/{id}/status', [PackageController::class, 'updateStatus'])->name('packages.updateStatus');
    Route::get('/filter-reservation', [ReservationController::class, 'filterReservation'])->name('filterReservation');
    Route::post('/delete-receipt-image', [ReservationController::class, 'deleteReceiptImage'])->name('deleteReceiptImage');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/get-utensils/{cateringOptionId}', [InventoryController::class, 'getUtensils']);
    Route::patch('/inventory/{id}/status', [InventoryController::class, 'updateStatus']);
    Route::patch('/inventory/{id}/update-quantity', [InventoryController::class, 'updateQuantity'])->name('inventory.updateQuantity');
    Route::patch('/inventory/{id}/utensil-status', [InventoryController::class, 'utensilStatus'])->name('inventory.utensilStatus');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/menu/{menuId}/comments', [MenuController::class, 'getComments'])->name('menu.comments');
...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/cart/remove/{item}', [CartController::class, 'remove'])->name('cartRemove');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/rate-menu', [OrderController::class, 'storemenu'])->name('rateMenu');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/reservation/latest', [FrontendReservationController::class, 'thankyou'])->name('reservations.thankyou');
    ...
    Route::get('/get-packages', [FrontendReservationController::class, 'getPackages'])->name('getPackages');
...
Route::post('/receiptImage', [RatingController::class, 'store'])->name('receiptImage');
